"""
Django settings for switchinfo_docker project.
...
ROOT_URLCONF = "switchinfo_docker.urls"
...
WSGI_APPLICATION = "switchinfo_docker.wsgi.application"
...
BACKUP_WEB_BASE = os.environ.get("GITLIST_BASE_URL", "/gitlist") + "/Config/blob/HEAD/"
